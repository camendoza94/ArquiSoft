...
public class Signup extends Controller {
	...
	public Result doForgotPassword() {
		...
		if (filledForm.hasErrors()) {
			...
			final UsuarioEntity user = UsuarioEntity.findByEmail(email);
			if (user != null) {
	...
	public Result resetPassword(final java.lang.String token) {
		com.feth.play.module.pa.controllers.Authenticate.noCache(response());
	...
	public Result doResetPassword() {
		...
		if (filledForm.hasErrors()) {
			...
			final UsuarioEntity u = ta.targetUser;
			try {
	...
	public Result verify(final java.lang.String token) {
		com.feth.play.module.pa.controllers.Authenticate.noCache(response());
		...
		UsuarioEntity.verify(ta.targetUser);
		flash(Application.FLASH_MESSAGE_KEY,
