...
public class MyUsernamePasswordAuthProvider
	...
	protected SignupResult signupUser(final MyUsernamePasswordAuthUser user) {
		final UsuarioEntity u = UsuarioEntity.findByUsernamePasswordIdentity(user);
		if (u != null) {
			if (u.emailValidated) {
		...
		final UsuarioEntity newUser = UsuarioEntity.create(user);
	...
	protected LoginResult loginUser(
		...
		final UsuarioEntity u = UsuarioEntity.findByUsernamePasswordIdentity(authUser);
		if (u == null) {
	...
	@Override
	protected Body getVerifyEmailMailingBody(final java.lang.String token,
			final MyUsernamePasswordAuthUser user, final Context ctx) {
	...
	protected String generateVerificationRecord(
		...
		return generateVerificationRecord(UsuarioEntity.findByAuthUserIdentity(user));
	}

	protected String generateVerificationRecord(final UsuarioEntity user) {
	...
	protected String generatePasswordResetRecord(final UsuarioEntity u) {
		final String token = generateToken();
		TokenAction.create(Type.PASSWORD_RESET, token, u);
		return token;
	}

	protected String getPasswordResetMailingSubject(final UsuarioEntity user,
			final Context ctx) {
	...
	protected Body getPasswordResetMailingBody(final String token,
			final UsuarioEntity user, final Context ctx) {
	...
	public void sendPasswordResetMailing(final UsuarioEntity user, final Context ctx) {
	...
	protected String getVerifyEmailMailingSubjectAfterSignup(final UsuarioEntity user,
			final Context ctx) {
	...
	public void sendVerifyEmailMailingAfterSignup(final UsuarioEntity user,
			final Context ctx) {
	...
	private String getEmailName(final UsuarioEntity user) {
